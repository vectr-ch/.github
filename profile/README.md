...
| [proto](https://github.com/vectr-ch/proto) | Shared Protobuf definitions and generated Go code used across all services. Includes the `DroneControl` gRPC service, pluggable transport layer (UDP and Reticulum), and the Reticulum bridge script. |
